...
public final class Const {
	...
	//Salon
	public static final int NBR_CLIENT_MAX, NBR_SALON_PERSOS_TOTAL, NBR_SALON_EQUIPE_MAX, NBR_SALON_PERSOS_EQUIPE_MAX;
	...
	static {
		...
		NBR_SALON_PERSOS_TOTAL = root.at("/salon/type_cps/nbr_persos_total").intValue();
		NBR_SALON_EQUIPE_MAX = root.at("/salon/type_equipe/nbr_equipe").intValue();
		NBR_SALON_PERSOS_EQUIPE_MAX = root.at("/salon/type_equipe/nbr_persos_equipe").intValue();
